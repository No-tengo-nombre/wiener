...
pub fn save_image_rgb_f32(path: &str, buffer: &[f32], width: i32, height: i32) {
    ...
    let result =
        image::ImageBuffer::<image::Rgb<f32>, &[f32]>::from_raw(width as u32, height as u32, buffer)
...
pub fn save_image_rgba_f32(path: &str, buffer: &[f32], width: i32, height: i32) {
    ...
    log::debug!("save_image :: Loading image from data");
    let result =
        image::ImageBuffer::<image::Rgba<f32>, &[f32]>::from_raw(width as u32, height as u32, buffer)
            .expect("Not enough memory was allocated");
...
pub fn save_image_rgb_u16(path: &str, buffer: &[u16], width: i32, height: i32) {
    ...
    log::debug!("save_image :: Loading image from data");
    let result =
        image::ImageBuffer::<image::Rgb<u16>, &[u16]>::from_raw(width as u32, height as u32, buffer)
            .expect("Not enough memory was allocated");
...
pub fn save_image_rgba_u16(path: &str, buffer: &[u16], width: i32, height: i32) {
    ...
    log::debug!("save_image :: Loading image from data");
    let result =
        image::ImageBuffer::<image::Rgba<u16>, &[u16]>::from_raw(width as u32, height as u32, buffer)
            .expect("Not enough memory was allocated");
